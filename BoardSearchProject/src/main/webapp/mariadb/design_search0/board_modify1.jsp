		...
		<div class="contents_sub">	
			...
			<div class="btn_area">
				<div class="align_left">
					...
					<input type="button" value="보기" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='board_view1.jsp?searchKey=<%=searchKey %>&searchWord=<%=searchWord %>&seq=<%=seq %>'" />
				</div>
